...
.then(function (data) {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        <a href="./detalleartistas.html?id=${topCanciones[i].id}"><img  class="foto" src=${topCanciones[i].album.cover_big}></a>
        <a class="ahome" href="./detalleartistas.html"><h4  class="canciones2322" >${topCanciones[i].title_short}</h4></a> 
        </div>`
    } 
       
    for (let i = 0; i < 5; i++) {
        album.innerHTML += `<div class="div1"> 
        <a href="./detalleartistas.html?id=${topAlbums[i].id}"><img  class="foto" src=${topAlbums[i].cover_big}></a>
        <a class="ahome" href="./detalleartistas.html"><h4  class="albums2322" >${topAlbums[i].title}</h4></a> 
        </div>`
    }
